...
view_groups = [
  ViewGroup(
    ...
    Rule('/goog_hybrid_login', endpoint='goog_hybrid_login',
         view='kay.ext.gaema.views.goog_hybrid_login'),
    ...
    Rule('/goog_hybrid_logout', endpoint='goog_hybrid_logout',
         view='kay.ext.gaema.views.goog_hybrid_logout'),
